...
class Ui_MainWindowBase(object):
    def setupUi(self, MainWindowBase):
        ...
        self.lineCheckBox = QtWidgets.QCheckBox(self.horizontalWidget)
        self.lineCheckBox.setChecked(True)
        self.lineCheckBox.setObjectName("lineCheckBox")
        self.horizontalLayout_5.addWidget(self.lineCheckBox)
        ...
        self.circleCheckBox = QtWidgets.QCheckBox(self.horizontalWidget1)
        self.circleCheckBox.setChecked(True)
        self.circleCheckBox.setObjectName("circleCheckBox")
        self.horizontalLayout_3.addWidget(self.circleCheckBox)
        ...
        self.markItemCheckBox = QtWidgets.QCheckBox(self.formWidget)
        self.markItemCheckBox.setObjectName("markItemCheckBox")
        self.horizontalLayout_2.addWidget(self.markItemCheckBox)
    ...
    def retranslateUi(self, MainWindowBase):
        ...
        self.lineCheckBox.setText(_translate("MainWindowBase", "Visible"))
        self.label.setText(_translate("MainWindowBase", "CIrcle radius:"))
        self.circleCheckBox.setText(_translate("MainWindowBase", "Visible"))
